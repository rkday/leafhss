...
(defn init-riak []
  ...
  (let [cxn (wc/connect)]
    (with-redefs [wc/*riak-client* cxn]
    ...
    (letfn
        [(get-public [impu]
         ...
         (update-scscf! [current-state sipuri diameter-host diameter-realm]
           (with-redefs [wc/*riak-client* cxn]
         ...
         (clear-scscf! [current-state]
           (update-scscf! current-state nil nil nil))

         (update-aka-seqn! [impi]
           (with-redefs [wc/*riak-client* cxn]
         ...
         (register! [current-state impi impu]
           (with-redefs [wc/*riak-client* cxn]
         ...
         (set-auth-pending! [current-state impi impu]
           (with-redefs [wc/*riak-client* cxn]
         ...
         (unregister! [current-state impi impu]
      ...
      [get-public get-private update-scscf! clear-scscf! update-aka-seqn! register! set-auth-pending! unregister!])))
